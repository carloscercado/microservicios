    ...
    def index(self):
        with self.conexion.atomic():
            try:
                ...
                res = [obj.as_dict_without("empresa", "estante") for obj in resultado]  # noqa E501
                return jsonify(res)
            except peewee.IntegrityError:
                raise CubiculoError("Problemas con Cubiculoes")
    ...
    def get(self, _id):
        with self.conexion.atomic():
            try:
                ...
                return jsonify(resultado.as_dict_without("empresa", "estante"))
    ...
    def post(self):
        with self.conexion.atomic():
            try:
                ...
                return jsonify(cubiculo.as_dict_without("empresa", "estante")), 201  # noqa E501
    ...
    def put(self, _id):
        with self.conexion.atomic():
            try:
                ...
                if Cubiculo.save() > 0:
                    return jsonify(Cubiculo.as_dict_without("empresa", "estante"))  # noqa E501
            except Cubiculo.DoesNotExist:
                raise CubiculoError("Cubiculo no existe", status=404)
            except peewee.IntegrityError as e:
